...
const AdultDentistry = () => {
  return (
    <Department
      departmentName='Adult Dentistry'
      overviewText='Our Adult Dentistry department provides comprehensive care for disorders of the nervous system. Our team of neurologists and neurosurgeons are experts in diagnosing and treating conditions affecting the brain, spinal cord, and peripheral nerves. We utilize advanced diagnostic tools and treatment modalities to provide personalized care for each patient.'
      services={[
        'Adult Dentistry Consultation',
        'EEG Testing',
