...
const IVFReproductiveMedicineAndSurgery = () => {
  return (
    <Department
      departmentName='IVF / Reproductive Medicine and'
      overviewText='Our IVF / Reproductive Medicine and department provides comprehensive care for disorders of the nervous system. Our team of neurologists and neurosurgeons are experts in diagnosing and treating conditions affecting the brain, spinal cord, and peripheral nerves. We utilize advanced diagnostic tools and treatment modalities to provide personalized care for each patient.'
      services={[
        'IVF / Reproductive Medicine and Consultation',
        'EEG Testing',
...
export default IVFReproductiveMedicineAndSurgery;
