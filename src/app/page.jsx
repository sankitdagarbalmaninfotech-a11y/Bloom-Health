        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-10'>
            ...
            <p className='max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground'>
              ...
              need it most. Whether you require urgent attention, a same-day consultation, or
              ongoing outpatient services, our highly experienced team is here to support you with
